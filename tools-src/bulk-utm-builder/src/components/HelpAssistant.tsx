...
const STORAGE_KEY = 'atomz_utm_help_seen';
      ...
      {isOpen && (
        ...
        >
          ...
          <p className="text-xs text-gray-300 font-medium leading-relaxed">
            Create trackable links without dealing with technical settings.
          </p>
          ...
          <div className="space-y-3 text-xs">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <span className="font-bold text-white block">Paste links</span>
                <span className="text-gray-400 text-[11px]">Add the website links you want to track.</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <span className="font-bold text-white block">Choose channel</span>
                <span className="text-gray-400 text-[11px]">Tell us where you will share them.</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <span className="font-bold text-white block">Create</span>
                <span className="text-gray-400 text-[11px]">Name your campaign and generate the tracked links.</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-2.5 bg-orange-500/10 border border-orange-500/20 rounded-xl text-[11px] text-orange-300">
            <strong>Tip:</strong> You usually do not need Advanced Settings.
          </div>
