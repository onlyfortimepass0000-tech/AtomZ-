        ...
        >
          <div className="flex items-start justify-between gap-2 pb-3 border-b border-[#24242A]">
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-[#F59E0B]/10 text-[#F59E0B] flex items-center justify-center text-xs font-bold">
                ?
              </span>
          ...
          <p className="text-xs font-semibold text-gray-200 my-3 leading-relaxed">
            “Turn orders into a warehouse-ready list.”
          </p>
          ...
          <ul className="space-y-2 mb-4">
            <li className="text-xs text-gray-300 flex items-start gap-2">
              ...
              <span>1. Upload orders.</span>
            </li>
            <li className="text-xs text-gray-300 flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#F59E0B] mt-1.5 shrink-0"></span>
              <span>2. We combine everything you need to pick.</span>
            </li>
            <li className="text-xs text-gray-300 flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#F59E0B] mt-1.5 shrink-0"></span>
              <span>3. Print your picking list and packing slips.</span>
            </li>
          </ul>

          <button
            onClick={() => setIsOpen(false)}
            className="w-full py-2 rounded-xl bg-[#F59E0B] hover:bg-[#f59e0b]/90 text-white font-bold text-xs shadow-md shadow-[#F59E0B]/20 flex items-center justify-center gap-1.5 transition-all"
          >
