      ...
      {isOpen && (
        ...
        >
          ...
          <p className="text-xs font-semibold text-gray-200 my-3 leading-relaxed">
            “Resize one creative for every platform in seconds.”
          </p>
          ...
          <ul className="space-y-2 mb-4">
            <li className="text-xs text-gray-300 flex items-start gap-2">
              ...
              <span>1. Upload your original image creative.</span>
            </li>
            <li className="text-xs text-gray-300 flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF5722] mt-1.5 shrink-0"></span>
              <span>2. Adjust crop, zoom, and background mode ONCE.</span>
            </li>
            <li className="text-xs text-gray-300 flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF5722] mt-1.5 shrink-0"></span>
              <span>3. Export every platform size in one ZIP.</span>
            </li>
          </ul>
