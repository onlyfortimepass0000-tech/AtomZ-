      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <a href="../../tools.html" className="flex items-center gap-2 text-white font-extrabold text-xl tracking-tight">
            <span className="w-8 h-8 rounded-lg bg-[#10B981] flex items-center justify-center text-white font-black text-sm shadow-lg shadow-[#10B981]/30">
              A
            </span>
            <span>ATOM<span className="text-[#10B981]">Z</span></span>
          </a>
