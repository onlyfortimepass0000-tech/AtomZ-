      ...
      {isOpen && (
        ...
        >
          ...
          <p className="text-xs font-semibold text-gray-200 my-3 leading-relaxed">
            “Update hundreds of prices together.”
          </p>
          ...
          <ul className="space-y-2 mb-4">
            <li className="text-xs text-gray-300 flex items-start gap-2">
              ...
              <span>1. Upload your catalog.</span>
            </li>
            <li className="text-xs text-gray-300 flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#10B981] mt-1.5 shrink-0"></span>
              <span>2. Choose your pricing rule.</span>
            </li>
            <li className="text-xs text-gray-300 flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#10B981] mt-1.5 shrink-0"></span>
              <span>3. Review and download.</span>
            </li>
          </ul>

          <button
            onClick={() => setIsOpen(false)}
            className="w-full py-2 rounded-xl bg-[#10B981] hover:bg-[#10b981]/90 text-white font-bold text-xs shadow-md shadow-[#10B981]/20 flex items-center justify-center gap-1.5 transition-all"
          >
