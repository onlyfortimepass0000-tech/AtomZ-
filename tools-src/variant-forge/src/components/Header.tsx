    ...
    <header className="border-b border-[#24242A] bg-[#0E0E10]/80 backdrop-blur sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-sm font-bold text-white leading-none">VariantForge</h1>
            <p className="text-[11px] text-gray-400 font-mono mt-0.5">Product & SKU Matrix Generator</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          {canUndo && (
            <button
              onClick={onUndo}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-300 bg-[#24242A] hover:bg-gray-700 rounded-xl transition-colors"
            >
          ...
          {hasVariants && (
            <button
              onClick={onReset}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-rose-400 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/20 rounded-xl transition-colors"
            >
